...
internal class GithubUsersPagedAdapter(
...
) : PaginatedAdapter<UserUiModel, GithubUsersPagedAdapter.UserVieHolder>(
    UserUiModelComparator
) {
    ...
    override fun viewHolder(parent: ViewGroup): GithubUsersPagedAdapter.UserVieHolder {
